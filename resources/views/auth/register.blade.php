            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="image" value="">
                        ...
                        <div class="form-group row">
                            <label for="licence" class="col-md-4 col-form-label text-md-right">{{ __('Licence') }}</label>

                        <div class="col-md-6">
                            <select id="Licence" type="text" class="form-control @error('licence') is-invalid @enderror" name="licence" value="{{ old('licence') }}" required autocomplete="licence" autofocus>
                                <option value="">選択して下さい</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="prefecture" type="text" class="form-control @error('prefecture') is-invalid @enderror" name="prefecture" value="{{ old('prefecture') }}" required autocomplete="prefecture" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="introduction" type="text" class="form-control @error('introduction') is-invalid @enderror" name="introduction" value="{{ old('introduction') }}" required autocomplete="introduction" autofocus row="4"></textarea>
